...
public class CaptureScreenShot {
	...
	public void screenshotCapture(WebDriver driver,String name) throws IOException {
		TakesScreenshot scrShot =(TakesScreenshot)driver;
		  ...
		  if (!f1.exists()){
			    f1.mkdirs();//for creating folder
			}
		  String timeStamp = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss").format(new Date());//for system current date and time
		//  String destination = System.getProperty("user.dir")+ "\\OutputScreenshots\\" + name + "_" + timeStamp + ".png";
